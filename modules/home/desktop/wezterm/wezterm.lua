...
return {
  ...
  default_cwd = '/Users/martin.gondermann/src',
  exit_behavior = 'Close',
  ...
  keys = {
    ...
    { key = 'g', mods = 'LEADER', action = act.SpawnCommandInNewTab({ args = { '/nix/store/wkwcszq7gdpdma6q0bn28phfxvv3vg2j-lazygit-0.40.2/bin/lazygit' } }) },
    { key = 'g', mods = 'CTRL', action = act.SpawnCommandInNewTab({ args = { '/nix/store/wkwcszq7gdpdma6q0bn28phfxvv3vg2j-lazygit-0.40.2/bin/lazygit' } }) },
